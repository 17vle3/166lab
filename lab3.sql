...
CREATE TABLE advise ( seniorSSN CHAR(11), gradSSN CHAR(11), PRIMARY KEY (seniorSSN, gradSSN), FOREIGN KEY (seniorSSN) REFERENCES Graduate (gSSN), FOREIGN KEY (gSSN) REFERENCES Graduate );
